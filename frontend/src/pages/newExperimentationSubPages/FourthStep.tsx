...
export function FourthStep({state, setState}:StepState){
    return <div>
                <div>
                    ...
                    <Input type="date" title="Début de la pratique" variant="withErrorMsg" value={state.pedagogyBeginningOld} onChange={e => {setState({...state, pedagogyBeginningOld: e.target.value})}}/>
                    <Input type="date" title="Fin de la pratique" variant="withErrorMsg" value={state.pedagogyEndingOld} onChange={e => {setState({...state, pedagogyEndingOld: e.target.value})}}/>
                ...
                <div>
                    ...
                    <Input type="date" title="Début de la pratique" variant="withErrorMsg" value={state.pedagogyBeginningNew} onChange={e => {setState({...state, pedagogyBeginningNew: e.target.value})}}/>
                    <Input type="date" title="Fin de la pratique" variant="withErrorMsg" value={state.pedagogyEndingNew} onChange={e => {setState({...state, pedagogyEndingNew: e.target.value})}}/>
