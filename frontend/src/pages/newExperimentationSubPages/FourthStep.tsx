...
export function FourthStep({state, setState}:StepState){
    return <div>
                <div>
                    <h4>Pour le moyen pédagogique habituel</h4>
                    ...
                    <Input type="date" title="Date de l'évaluation comptabilisée" value={state.accountedEvaluationOld} onChange={e => {setState({...state, accountedEvaluationOld: e.target.value})}}/>
                </div>
                <div>
                    <h4>Pour le nouveau moyen pédagogique</h4>
                    ...
                    <Input type="date" title="Date de l'évaluation comptabilisée" value={state.accountedEvaluationNew} onChange={e => {setState({...state, accountedEvaluationNew: e.target.value})}}/>
                </div>
