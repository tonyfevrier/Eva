...
@Component
public class PdfQuestionnaireImportStrategy implements FileImportStrategy {
    @Value("${app.pdf-dir}")
    ...
    public boolean supports(String importType){
        return "questionnaire".equals(importType);
    }
    ...
    public String createImportedFileName(Long id, String extension) {
        return "questionnaire_id" + id + "_1." + extension;
    }
