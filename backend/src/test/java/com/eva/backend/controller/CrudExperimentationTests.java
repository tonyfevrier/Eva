...
public class CrudExperimentationTests {
    ...
    public void testGetExperimentationListOfOneUser() throws Exception {
        ...
        mockMvc.perform(get("/expe/getAllOfOneUser")
                        ...
                        .andExpect(jsonPath("$[1].institutionTown").value("Marseille"))
                        ...
                        .andExpect(jsonPath("$[0].institutionTown").value("Marseille"))
    ...
    public void testGetExperimentationList() throws Exception {
        ...
        // Récupérer la liste des expérimentations de l'utilisateur sans cookie  l'url étant accessible à tous
